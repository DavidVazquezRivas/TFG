...
Siguiendo el enfoque de \ac{DDD}\cite{evans2004ddd}, se ha diseñado un modelo de datos que refleja fielmente el dominio de la aplicación. Este modelo se ha estructurado en torno a las entidades principales del dominio, utilizando un enfoque orientado a objetos, no obstante se ha optado por una representación relacional para su implementación en la base de datos mediante \ac{MER}\cite{chen1976entity}.

Dado la complejidad del modelo de datos, se ha optado por dividirlo en varios diagramas por módulos o \emph{bounded contexts} para facilitar su comprensión y mantenimiento.
