...
La gestión de proyectos de software es un dominio maduro con multitud de herramientas consolidadas (como Jira, Asana o Trello \cite{trello_software}). No obstante, la constante evolución de las metodologías de trabajo y el auge de la \ac{IA} están forzando un cambio de paradigma en cómo se visualiza la información y cómo se interactúa con el sistema.
