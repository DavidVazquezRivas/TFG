...
% Nota: se han eliminado `geometry`, `titlesec`, `fancyhdr` y `biblatex` porque la clase
% `TFGEPSUIB` gestiona márgenes, estilos de capítulo, encabezados/pies y la plantilla
% oficial usa BibTeX/IEEEtran para la bibliografía.
